...
This repository contains the code for the **UFLUX emulator paper**, which introduces a process-informed machine learning framework for estimating ecosystem carbon and water fluxes.
